#!/usr/bin/env python3
"""
Direct Registration Test Script
This bypasses CORS by testing the endpoint directly from Python.
"""
...
def test_direct_registration():
    """Test the registration endpoint directly without CORS."""
    ...
    try:
        # Test registration directly (no CORS)
