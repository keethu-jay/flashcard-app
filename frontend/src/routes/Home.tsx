...
// This is the main container that will split the page into left and right sections
...
const LeftContentContainer = styled.div`
    flex: 2; /* Changed from 3 to 2 for a more balanced split with RightContentContainer's flex:1 */
    display: flex;
...
const RightContentContainer = styled.div`
    flex: 3; /* Takes 1 part of the available space, e.g., ~33% */
    display: flex;
    ...
    return (
        <MainLayoutContainer>
            <LeftContentContainer>
                ...
                {/* THIS IS WHERE YOU NEED TO ADD THE BUTTON */}
